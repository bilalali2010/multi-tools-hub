...
if tool == "Logo Prompt Generator":
    ...
    if st.button("Generate Prompt"):
        ...
        st.download_button("📥 Download Prompt", output, file_name=f"{brand[:20]}_logo_prompt.txt")
...
# -------- AI Chatbot --------
    ...
    if st.button("Send"):
        ...
        st.download_button("📥 Download Response", output, file_name="chatbot_response.txt")
...
# -------- Text Rewriter --------
    ...
    if st.button("Rewrite"):
        ...
        st.download_button("📥 Download Rewritten Text", output, file_name="rewritten_text.txt")
...
# -------- Meme Idea Generator --------
    ...
    if st.button("Generate Meme Ideas"):
        ...
        st.download_button("📥 Download Meme Ideas", output, file_name="meme_ideas.txt")
...
# -------- AI Blog Generator --------
    ...
    if st.button("Generate Blog"):
        ...
        st.download_button("📥 Download Blog", output, file_name=f"{topic[:20]}_blog.txt")
